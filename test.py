...
score_columns = ["x score", "xii overall score"]
...
top_students["JEE Mains score"] = top_students["JEE Mains score"].astype(str).str.replace(",", " ")
...
columns_to_display = ["User ID", "first name", "gender", "10th board", "x score", "12th board", 
                      "xii overall score", "math score", "JEE Mains score", "family income", "Tier"]
...
format_excel("Top_Students.xlsx")
print("\n✅ Top 3 students saved to 'Top_Students.xlsx'")
